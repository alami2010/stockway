...
/**
 * Criteria class for the {@link com.jbd.stock.domain.Role} entity. This class is used
 * in {@link com.jbd.stock.web.rest.RoleResource} to receive all the possible filtering options from
...
public class RoleCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, usersId, distinct);
    }
