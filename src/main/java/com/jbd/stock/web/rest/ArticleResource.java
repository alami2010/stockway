...
import com.jbd.stock.service.ArticleQueryService;
...
/**
 * REST controller for managing {@link com.jbd.stock.domain.Article}.
 */
@RestController
@RequestMapping("/api")
public class ArticleResource {
    ...
    public ResponseEntity<List<ArticleDTO>> getAllArticles(
        ...
        @RequestParam(required = false) Long statusF,
        @RequestParam(required = false) String searchF,
    ...
    @GetMapping("/articles/download-file/{fileName}")
    public ResponseEntity<Resource> downloadFile(@PathVariable EXPORT_FILE_TYPE fileName) throws Exception {
