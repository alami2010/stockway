...
describe('Charge Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'charge', component: ChargeComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to chargeService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getChargeIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getChargeIdentifier).toHaveBeenCalledWith(entity);
