...
export class ArticleComponent implements OnInit {
  ...
  protected queryBackend(
    ...
    const queryObject: any = {
      statusF: this.currentStatusFilter ? this.currentStatusFilter : undefined,
      searchF: this.currentSearchFilter ? this.currentSearchFilter : undefined,
      page: pageToLoad - 1,
  ...
  search() {
    console.info(this.currentSearchFilter);
    console.info(this.currentStatusFilter);
    this.load();
  }
